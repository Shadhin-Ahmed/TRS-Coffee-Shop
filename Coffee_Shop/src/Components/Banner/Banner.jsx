            ...
            <div className='container min-h-[550px] flex justify-center items-center py-12 sm:py-0'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                    ...
                    <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                        ...
                        >
                           "Indulge in the rich aroma and bold flavor of our Premium Blend Coffee, crafted from the finest beans. Perfectly roasted to deliver a smooth, velvety taste with every sip. Elevate your coffee experience today!"
                        </p>
